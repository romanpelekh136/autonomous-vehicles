...
def linear_schedule(initial_value):
    """Лінійне зменшення значення від initial_value до 0 протягом тренування."""
...
class CheckpointMetricCallback(BaseCallback):
    """Логує середній прогрес по трасі в TensorBoard кожні 100 епізодів."""
...
def make_env():
    """Створює тренувальне середовище з випадковою трасою."""
...
def optimize_ppo(trial):
    ...
    total_progress = []
    try:
        for _ in range(3):  # 3 епізоди на трасу
            obs = eval_env.reset()
...
if __name__ == '__main__':
    if OPTIMIZE:
        ...
        eval_cb = EvalCallback(
            ...
            eval_freq=25_000 // 8,  # з урахуванням 8 паралельних середовищ
            n_eval_episodes=5,
            deterministic=True,
            verbose=1
        )
